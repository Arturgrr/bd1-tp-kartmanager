...
func (req CreatePilotoReq) Valid(context.Context) validator.Evaluator {
	var eval validator.Evaluator
	eval.CheckField(validator.NotBlank(req.Cpf), "cpf", "must not be blank")
	eval.CheckField(validator.MinChars(req.Cpf, 11) && validator.MaxChars(req.Cpf, 11), "cpf", "must be 11 characters")
